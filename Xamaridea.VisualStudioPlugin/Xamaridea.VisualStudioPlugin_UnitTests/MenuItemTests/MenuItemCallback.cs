...
using EgorBo.Xamaridea_VisualStudioPlugin;

namespace Xamaridea.VisualStudioPlugin_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new Xamaridea_VisualStudioPluginPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(EgorBo.Xamaridea_VisualStudioPlugin.GuidList.guidXamaridea_VisualStudioPluginCmdSet, (int)EgorBo.Xamaridea_VisualStudioPlugin.PkgCmdIDList.cmdidOpenInIdeaCommand);
